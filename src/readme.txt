...
- Go to the corresponding chapter folder in this repo
- Identify which sections in that chapter contain Logika proofs/truth tables
    (they tend to be multiple lines in a black box). The earliest section with Logika proofs (in this case,
     a truth table) is 2.2.
